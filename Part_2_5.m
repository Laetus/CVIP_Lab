...
%% 
% <latex>
% Now we apply a Fourier Transformation, to see the picture in frequential
% domain. This transformation is very popular, so it is already implemented
% in \texttt{MATLAB}. The matrix w
% </latex>
...
% we see, that the rows and colums in which the peaks are often bigger,
